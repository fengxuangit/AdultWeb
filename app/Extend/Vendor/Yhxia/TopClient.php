...
class TopClient
{
	public $appkey;
	public $secretKey;
	public $gatewayUrl = "http://api.yhxia.com/api/";
	public $format = "json";
	/** 是否打开入参check**/
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt)
	{
		...
		$logger = new LtLogger;
		$logger->conf["log_file"] = $this->_CachePath . "yhxia/top_comm_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
	...
	public function execute($request, $session = null)
	{
		...
		$this->_CachePath = $this->_CachePath . "runtime/Data/yhxia_api_cache/";
		//组装系统参数
		...
		{
			$logger = new LtLogger;
			$logger->conf["log_file"] = $this->_CachePath . "yhxia/top_biz_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
			$logger->log(array(
				date("Y-m-d H:i:s"),
				$resp
			));
