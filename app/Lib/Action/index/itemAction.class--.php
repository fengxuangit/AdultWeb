...
class itemAction extends FirstendAction {
    ...
    public function _initialize() {
        ...
        $this->_yhconfig = unserialize($api_config);
    }
    ...
    public function index() {
		...
		$item['newhot'] = round(date('Ymd')-date("Ymd", $item['coupon_start_time']));
	...
	private function _get_yh_top() {
        vendor('Yhxia.TopClient');
        vendor('Yhxia.RequestCheckUtil');
        vendor('Yhxia.Logger');
        $tb_top = new TopClient;
        $tb_top->appkey = $this->_yhconfig['app_key'];
        $tb_top->secretKey = $this->_yhconfig['app_secret'];
        return $tb_top;
    }
