...
<div class="common-form pad_lr_10">
	<form id="info_form" action="{:u('cache/clear')}" method="post">
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
				<th></th>
				<td><label><input type="checkbox" checked value="api" name="type" class="mr5" data-uri="{:U('cache/clear', array('type'=>'api'))}"> API缓存</label></td>
				<td><span class="gray mr10">清空开放平台API缓存文件</span><span id="api_ifm"></span></td>
			</tr>
            <tr>
            	<th></th>
