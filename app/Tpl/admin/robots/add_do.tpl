    ...
    <table width="100%" cellspacing="0" class="table_form">
        <tbody>
			...
			<tr>
                <th>佣金：</th>
                <td>
                    <input type="text" name="start_commissionRate" size="5" class="input-text" value="100"  /> - 
                    <input type="text" name="end_commissionRate" size="5" class="input-text" value="9999" />
			...
			<tr>
                <th>价格：</th>
                <td>
                    <input type="text" name="start_price" size="5" class="input-text" value="10"/> - 
                    <input type="text" name="end_price" size="5" class="input-text" value="9999"/> 
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="start_volume" size="5" class="input-text" value="10" /> - 
                    <input type="text" name="end_volume" size="5" class="input-text" value="999999" /> 
